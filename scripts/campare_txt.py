...
path_txts_accurate = r"D:\A_myData\dataset\juanZhou3\labels"  # 人打的准确的标签
path_txts_predict = r"D:\A_myData\Pytorch\yolov5-master\runs\detect\exp57\labels"   # 模型预测的标签
...
for txt_accurate in tqdm(list_txt_accurate):
    ...
    with open(path_txt_accurate,'r') as file_accurate , \
        ...
        for line_accurate in file_accurate:
            ...
            have_label = [True for x in file_predict if x.split(" ")[0] == label_accurate]
            if have_label:
