...
# 定义路径（根据实际路径修改）
images_dir = r"D:\A_myData\dataset\corner3\images"  # 原始图片文件夹
json_dir = r"D:\A_myData\dataset\corner3\jsons"  # JSON文件夹
output_dir = r"D:\A_myData\dataset\corner3\images_no_blank"  # 目标输出文件夹
