...
if __name__ == '__main__':
    file_path = r"F:\RC2026_OFFLINE\datasets\juanZhou_det_mix5\images" # 这里放你存JPG照片的地址
    txtpath = r"F:\RC2026_OFFLINE\datasets\juanZhou_det_mix5\labels" # 这里放你存label的地址
    new_file_path = r"F:\RC2026_OFFLINE\datasets\juanZhou_det_mix5_split"  # 这里填你打算新建立的文件夹的名字
