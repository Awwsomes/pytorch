class Path:
    def __init__(self):
        self.raw_data_root_path = r"D:\A_myData\RC26-Vision\dataset\A_car\raw_data\2026_5_14"
        self.output_root_path = r"D:\A_myData\RC26-Vision\dataset\A_car\2026_5_14_blue"
...
class ClassConfig:
    def __init__(self):
        ...
        self.start_idx = 0
        self.img_root_name = "juanZhou_car_blue4"   # 需手动加与序号的分隔符，如"_"
...
class DetectConfig:
    def __init__(self):
        self.model_path = r"D:\A_myData\RC26-Vision\Pytorch\yolov5-master\runs\train\角点检测_蓝色2\weights\best.pt"
        self.data_yaml = r"D:\A_myData\RC26-Vision\Pytorch\pytorch\dataset_yaml\corner_blue2.yaml"
        self.conf_thres = 0.3
        self.iou_thres = 0.3
        self.max_det = 64
