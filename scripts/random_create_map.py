...
def generate_urdf_file(output_file_rootname, output_path=None, n=1, launch_path=None, txt_path=None):
    ...
    for file_index in range(1, n + 1):
        ...
        if output_path:
            ...
            # 修改文件名：map1.urdf, map2.urdf, ..., mapn.urdf
            full_output_path = os.path.join(output_path, f"{output_file_rootname}{file_index}.urdf")
        else:
            full_output_path = f"{output_file_rootname}{file_index}.urdf"
      ...
      <joint
        ...
        dynamic_link_templates = [
          ...
          <link
            ...
            <inertial>
              <origin
                ...
                rpy="0 0 0" />
              <mass
                value="42.8749999999999" />
              <inertia
                ixx="0.875364583333331"
                ixy="2.08253553291014E-17"
                ixz="2.08253553291015E-17"
                iyy="0.87536458333333"
                iyz="3.98899663300867E-17"
                izz="0.87536458333333" />
            </inertial>
            <visual>
              <origin
                xyz="0 0 0"
            ...
            <collision>
              ...
              <geometry>
                <mesh
                  filename="package://zwei/meshes/Link25.STL" />
              </geometry>
            </collision>
          </link>
          <joint
          ...
          <link
            ...
            <inertial>
              <origin
                xyz="0 0.165 -4.44089209850063E-16"
                rpy="0 0 0" />
              <mass
                value="42.875" />
              <inertia
                ixx="0.875364583333331"
                ixy="5.86914776038772E-19"
                ixz="-2.01311768181315E-16"
                iyy="0.875364583333331"
                iyz="-5.86914776038792E-19"
            ...
            <collision>
              ...
              <geometry>
                <mesh
                  filename="package://zwei/meshes/Link26.STL" />
              </geometry>
            </collision>
          </link>
          <joint
          ...
          <link
            ...
            <inertial>
              ...
              <inertia
                ixx="0.875364583333331"
                ixy="4.60222138176646E-17"
                ixz="4.61436444609835E-18"
                iyy="0.875364583333331"
                iyz="-5.86914776038796E-19"
            ...
            <collision>
              ...
              <geometry>
                <mesh
                  filename="package://zwei/meshes/Link27.STL" />
              </geometry>
            </collision>
          </link>
          <joint
          ...
          <link
            ...
            <inertial>
              ...
              <inertia
                ...
                ixy="3.15517288222248E-17"
                ixz="4.33305012241074E-17"
                iyy="0.875364583333333"
                iyz="-3.52958403245416E-17"
                izz="0.875364583333332" />
            </inertial>
            <visual>
              <origin
            ...
            <collision>
              ...
              <geometry>
                <mesh
                  filename="package://zwei/meshes/Link28.STL" />
              </geometry>
            </collision>
          </link>
          <joint
